...
if __name__ == "__main__":
    args = sys.argv[1:]
    input_path = "/app/input_videos/" + args[0]
    input_filename_no_ext = ".".join(args[0].split(".")[:-1])
    extension = args[0].split(".")[-1]
    output_filename = "/app/output_videos/" + \
        input_filename_no_ext + "_detections." + extension
    ...
    # Open the video file
    video_path = '/app/input_videos/min_trim.mkv'
